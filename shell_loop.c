 ...
 * @av: represnts the argument vector from main()
 *
 * Return: returns 0 on success, 1 on error code
 */
 ...
 * @info: reps the parameter & return info struct
 * Winifredcode7
...
/**
 * find_cmd - this functions finds a command in PATH
 * @info: reps the parameter & return info struct
 *
 * Return: void
 */
