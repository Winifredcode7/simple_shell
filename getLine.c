...
/**
 * input_buf - this is the function that buffers chained commands
 ...
 * @info: info is the parameter struct
 * @ptr: The address of pointer to buffer,
 * preallocated or NULL
 * @length: the lenght size of preallocated
 * ptr buffer if not NULL
 *
 * Return: s
 */
