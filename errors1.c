 ...
 * @info: This is return info struct
...
/**
 * print_d - This is the function prints
...
/**
 * remove_comments - this is a function that
 * replaces first instance of '#' with '\0'
 * @buf: stands for the address of the string to modify
 *
 * Return: 0 always.
 */
