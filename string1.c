 ...
 * @str: reps the string to duplicate
 *
...
/**
 * _puts - reps the prints an input string
 * @str: reps the string to be printed
 *
 * Return: Null
 */
