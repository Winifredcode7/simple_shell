 ...
 * @info: represnts the parameter struct
 *
 ...
 * @info:  represets the Structure containing potential arguments.
...
/**
 * renumber_history - This functions renumbers the
 * history linked list after changes
 * @info: rep the Structure containing potential arguments.
 *
