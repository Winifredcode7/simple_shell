...
/**
 * is_chain - this function test if current
 * char in buffer is a chain delimeter
 * @info:  reps the parameter struct
 * @buf: reps the char buffer
 * @p: reps address of current position in buf
 * Winifredcode7
 ...
 * @buf: reps the char buffer
 * @p: reps address of current position in buf
 * @i: reps starting position in buf
 * @len: reps length of buf
 *
 * Return: void
 */
...
/**
 * replace_alias - this function replaces
 ...
 * @old: reps the address of old string
 * @new: reps the new string
 *
 * Return: 1 if replaced, 0 if not
 */
